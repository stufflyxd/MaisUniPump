...
class TelaCriarFichaTreino_Funcionario : BaseActivity() {
    ...
    private fun setupRecyclerView() {
        Log.d("SETUP_RECYCLERVIEW", "=== CONFIGURANDO RECYCLERVIEW COM GLIDE ===")

        exerciciosAdapter = ExerciciosGrupoAdapter(exerciciosList) { exercicio ->
            // CALLBACK MELHORADO com mais logs
            Log.d("EXERCICIO_CALLBACK", "=== CALLBACK EXERCÍCIO SELECIONADO ===")
            Log.d("EXERCICIO_CALLBACK", "Nome: '${exercicio.nome}'")
            Log.d("EXERCICIO_CALLBACK", "ID: '${exercicio.id}'")
            Log.d("EXERCICIO_CALLBACK", "Grupo: '${exercicio.grupoMuscular}'")
            Log.d("EXERCICIO_CALLBACK", "Frame: '${exercicio.frame}'")
            Log.d("EXERCICIO_CALLBACK", "Modo Edição: $modoEdicao")
            Log.d("EXERCICIO_CALLBACK", "Action: '$action'")
            Log.d("EXERCICIO_CALLBACK", "Document ID: '$documentId'")
            Log.d("EXERCICIO_CALLBACK", "Aluno ID: '$alunoDocId'")
        ...
        Log.d("SETUP_RECYCLERVIEW", "✅ RecyclerView configurado com sucesso")
    }
    ...
    // MÉTODO MODIFICADO: Carrega exercícios COM FRAME para o Glide
    private fun carregarExerciciosDoGrupo(grupoMuscular: String) {
        Log.d("CARREGAR_EXERCICIOS", "=== CARREGANDO EXERCÍCIOS COM GLIDE ===")
                        ...
                        if (exerciciosArray != null && exerciciosArray.isNotEmpty()) {
                            ...
                            exerciciosArray.forEachIndexed { index, exercicioMap ->
                                try {
                                    ...
                                    // CRÍTICO: Incluir frame para o Glide
                                    ...
                                    val exercicio = ExercicioGrupo(
                                        ...
                                        nome = nome,
                                        frame = frame, // INCLUIR FRAME
                                        grupoMuscular = grupoMuscular
                                    )

                                    exercicios.add(exercicio)
                                    Log.d("CARREGAR_EXERCICIOS", "✅ Exercício adicionado: '${exercicio.nome}' (Frame: '${exercicio.frame}')")
    ...
    private fun onExercicioSelecionado(exercicio: ExercicioGrupo) {
        ...
        Log.d("EXERCICIO_SELECIONADO", "Frame: ${exercicio.frame}")
    ...
    // MÉTODO MODIFICADO: Adiciona exercício COM FRAME ao Firestore
    private fun adicionarExercicioAFichaExistente(exercicio: ExercicioGrupo) {
        Log.d("ADD_EXERCICIO_FICHA", "=== ADICIONANDO EXERCÍCIO À FICHA COM GLIDE ===")
        Log.d("ADD_EXERCICIO_FICHA", "Exercício: '${exercicio.nome}'")
        Log.d("ADD_EXERCICIO_FICHA", "Frame: '${exercicio.frame}'")
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    try {
                        ...
                        // MODIFICADO: Criar novo exercício COM FRAME
                        val novoExercicio = mapOf(
                            "nome" to exercicio.nome,
                            "frame" to exercicio.frame, // INCLUIR FRAME REAL
                            ...
                            .addOnSuccessListener {
                                ...
                                runOnUiThread {
                                    ...
                                    val resultIntent = Intent().apply {
                                        ...
                                        putExtra("exercicio_frame", exercicio.frame) // INCLUIR FRAME NO RETORNO
    ...
    private fun navegarParaProximaTela(exercicio: ExercicioGrupo) {
        ...
        intent.putExtra("frameExercicio", exercicio.frame) // INCLUIR FRAME
...
class TelaCriarFichaTreino_Funcionario :  {
    ...
    private fun setupRecyclerView() {
        Log.d("SETUP_RECYCLERVIEW", "=== CONFIGURANDO RECYCLERVIEW ===")
